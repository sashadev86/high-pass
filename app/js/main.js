...
/* harmony import */ var _components_panel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/panel */ "./src/js/components/panel.js");
/* harmony import */ var _components_panel__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_panel__WEBPACK_IMPORTED_MODULE_3__);
...
const scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_3___default())('a[href*="#"]'); // Подключение событий свайпа на мобильных
...
ymaps.ready(['Panel']).then(function () {
  ...
  var office = '<h3 class="map__title">Студия «High pass»</h3> + <p class="map__text">107045, Москва, Даев переулок, дом 41, бизнес-центр «Даев Плаза», этаж 8, офис № 82</p> + <a class="map__link" href="tel:+749542423532"><img src="img/telMap.svg" alt="Телефонная трубка">+7 495 424-23-532</a>'; // Создадим и добавим панель на карту.

  var panel = new ymaps.Panel();
  map.controls.add(panel, {// float: 'left'
  ...
  collection.add(new ymaps.Placemark([55.769651, 37.639383], {
    balloonContent: office
  })); // Добавим коллекцию на карту.

  map.geoObjects.add(collection); // Подпишемся на событие клика по коллекции.

  collection.events.add('click', function (e) {
    // Получим ссылку на геообъект, по которому кликнул пользователь.
    var target = e.get('target'); // Зададим контент боковой панели.

    panel.setContent(target.properties.get('balloonContent')); // Переместим центр карты по координатам метки с учётом заданных отступов.
...
ymaps.modules.define('Panel', ['util.augment', 'collection.Item'], function (provide, augment, item) {
  ...
  augment(Panel, item, {
    onAddToMap: function (map) {
      ...
      this.getParent().getChildElement(this).then(this._onGetChildElement, this); // Добавим отступы на карту.
    ...
    _onGetChildElement: function (parentDomContainer) {
      ...
      this._$content = $('.content'); // При клике по крестику будем скрывать панель.
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.contacts__form', rules1, afterForm);
...
const throttle = function (func) {
  let delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 2500;
